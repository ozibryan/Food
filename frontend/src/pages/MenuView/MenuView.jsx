    ...
    <div className="sub-main">
      <div className="menu-container">
          ...
          <div className="menu-main">
            <div className="menu-head">
              ...
              <div className="menu-buttons-main">
                ...
                <button className="plan-button" onClick={addPlan}>
                  Plan
                </button>
              </div>
            </div>
            ...
            <div className="menu-company-main">
              ...
              <p style={{ fontSize: 12 }}>{data.cuisine}</p>
            </div>
            ...
            <div className="menu-instructions-main">
              ...
              <div className="instructions">
                ...
                <p style={{ fontSize: 14 }}>{data.preptime} mins</p>
        ...
        <div className="balance-main">
          ...
          <p style={{ fontSize: 10, marginTop: 10, color: "gray" }}>
            % Daily values on a 2,0000 calorie diet
          </p>
      ...
      <div style={{ display: "flex", gap: "20px" }}>
        ...
        <div className="instructions-main">
          ...
          {data.instruction.map((e) => (
            <div key={e.step}>
              <p style={{ fontSize: 14, marginBottom: 2 }}>{e.step}</p>
              <p style={{ fontSize: 12, marginBottom: 15, color: "gray" }}>
                {e.instruction}
              </p>
            </div>
          ))}
