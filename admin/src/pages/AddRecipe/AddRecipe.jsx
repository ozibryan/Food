  ...
  const onSubmitHandler = async (event) => {
    ...
    ingredients.forEach((ingredient, index) => {
      ...
      if (ingredient.image) {
        ...
        // formData.append(`ImagesTwo[${index}]`, ingredient.image);
        ...
        <div className="index-list">
          <ul>
            {instructions.map((instr, index) => (
              <li key={index}>
                Step {instr.step}: {instr.instruction}
                <button type="button" onClick={() => editInstruction(index)} className="add-upd-btn">
                  Edit
                </button>
                <button type="button" onClick={() => removeInstruction(index)} className="add-upd-btn">
                  Remove
                </button>
              </li>
            ))}
